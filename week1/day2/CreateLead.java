...
public class CreateLead {
	...
	public static void main(String[] args) throws InterruptedException, IOException  {
		...
		driver.findElementById("createLeadForm_annualRevenue").sendKeys("100 Billion USD");
		Select industry = new Select(driver.findElementById("createLeadForm_industryEnumId"));
		//industry.getFirstSelectedOption();
		//	for(WebElement eachOption:industry.getOptions()) {
		//		if(industry.getOptions().lastIndexOf(eachOption)==(industry.getOptions().size()-1))
